...
class SpotifyUser(
	...
	fun getArtistAlbums(artistId: String) = ArtistAlbumsQuery.Builder(artistId, accessToken)

	fun getArtistTopTracks(artistId: String) = ArtistTopTracksQuery.Builder(artistId, accessToken)
